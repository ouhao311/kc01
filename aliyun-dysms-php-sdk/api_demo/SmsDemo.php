...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAI4GJcKDEGmRYejti4teud"; // AccessKeyId

        $accessKeySecret = "fKxf8YXexCgFMADm4TTf3NYObJ0GIk"; // AccessKeySecret
    ...
    public static function sendSms($con) {
        ...
        $request->setSignName("初心驿站");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode($con['code']);
