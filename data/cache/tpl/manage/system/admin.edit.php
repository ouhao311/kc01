...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?url=admin&do=admin" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['hx_limit_manage'];?> - <?php echo $lang['hx_edit'];?>管理员“<?php echo $admininfo['admin_name'];?>”</h3>
  ...
  <form id="admin_form" method="post" action='index.php?url=admin&do=admin_edit&admin_id=<?php echo $admininfo['admin_id'];?>'>
    ...
    <div class="ncap-form-default">
      <dl class="row">
        ...
        <dd class="opt">
          <input type="text" class="input-txt" value="<?php echo $admininfo['admin_name'];?>" readonly />
          <span class="err"></span>
      ...
      <dl class="row">
        ...
        <dd class="opt">
         ...
         <dl class="row">
        <dt class="tit">
          <label for="admin_username"><em>*</em>姓名</label>
        </dt>
        <dd class="opt">
          <input type="text" id="admin_username"  value="<?php echo $admininfo['admin_username'];?>" name="admin_username" class="input-txt">
          <span class="err"></span>
          <p class="notic">请输入真实姓名</p>
        </dd>
      </dl>
            ...
            <dl class="row">
        <dt class="tit">
          <label for="admin_tel">电话</label>
        </dt>
        <dd class="opt">
          <input type="text" id="admin_tel" value="<?php echo $admininfo['admin_tel'];?>" name="admin_tel" class="input-txt">
          <span class="err"></span>
          <p class="notic">请输入电话</p>
        </dd>
      </dl>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <select name="gid">
            ...
            <option <?php if ($v['gid'] == $admininfo['admin_gid']) echo 'selected';?> value="<?php echo $v['gid'];?>"><?php echo $v['gname'];?></option>
            <?php }?>
          </select>
          <span class="err"></span>
