...
{display: '分类名称', name : 'title', width : 140, sortable : false, align: 'center'},
{display: '分类图标', name : 'pic', width: 100, sortable : true, align : 'center'},   
{display: '是否可发布', name : 'isfabu', width: 80, sortable : true, align : 'center'},
