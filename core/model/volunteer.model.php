...
class volunteerModel extends Model {
    ...
    public function __construct() {
        parent::__construct('volunteer_list');
    }
    ...
    private function _condition($condition){
		...
		$condition_str .= " and volunteer_list.isdel = 0 ";
        if ($condition['status'] != ''){
            $condition_str .= " and volunteer_list.status = '". $condition['status'] ."'";
        }
        if ($condition['memberid'] != ''){
            $condition_str .= " and volunteer_list.memberid in (". $condition['memberid'] .")";
        }
