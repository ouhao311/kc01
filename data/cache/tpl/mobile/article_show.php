...
<div id="article_view">
<header class="zyw-header"><a href="javascript:history.go(-1)" class="head-l xmIconfont"></a>
<div class="head-c">
动态详情
</div>
...
<div class="time">
<div class="left" style="flex: 2 1 0%;"><?php echo date('Y-m-d H:i:s',$info['addtime']);?></div>
<div class="xmIconfont watch"></div>
<div class="left"><?php echo $info['clicks'];?></div>
</div>
</div>
<div class="main"><br/>
