...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?url=admin&do=admin" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['hx_limit_manage'];?> - <?php echo $lang['hx_add'];?>管理员</h3>
  ...
  <form id="add_form" method="post">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input type="text" id="admin_username" name="admin_username" class="input-txt">
          <span class="err"></span>
        ...
        <dd class="opt">
          <input type="text" id="admin_tel" name="admin_tel" class="input-txt">
          <span class="err"></span>
...
maxlength: 20,
remote: {
                    url :'index.php?url=admin&do=ajax&branch=check_admin_name',
                    type:'get',
                    data:{
                    admin_name : function(){
...
maxlength: '<i class="fa fa-exclamation-circle"></i><?php echo $lang['admin_add_password_max'];?>'
            ...
            admin_username : {
                required : '<i class="fa fa-exclamation-circle"></i>真实姓名不能为空'
            }
        }
});
});
