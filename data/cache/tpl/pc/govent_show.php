...
<a href="<?php echo url('govent','index',array('pid'=>$classinfo['id']));?>">智慧政务</a> >
...
<ol>来源：<a href="<?php echo url('govent','index',array('id'=>$classinfo['id']));?>" target="_blank">智慧政务</a>  发布时间：<?php echo date('Y-m-d H:i:s',$info['addtime']);?>　点击数量:<span id="hits"><?php echo $info['clicks'];?></span></ol>
</div>
...
没有了
<?php } else { ?>
<a href="<?php echo url('govent','show',array('id'=>$preinfo['id']));?>"><?php echo $preinfo['title'];?></a><?php } ?>
</li>
<li><strong>下一篇：</strong>
<?php if(empty($nextinfo)) { ?>
没有了
<?php } else { ?>
<a href="<?php echo url('govent','show',array('id'=>$nextinfo['id']));?>"><?php echo $nextinfo['title'];?></a><?php } ?>
</li>
</ul>
</div>
</div>
