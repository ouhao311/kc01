...
<a href="<?php echo url('news','index',array('pid'=>$item['id']));?>" >
...
<a href="<?php echo url('news','index',array('pid'=>$topclassinfo['id']));?>"><span <?php if($_GET['pid']==$topclassinfo['id']) { ?>class="dtbh1"<?php } ?>
>全部</span></a>
<?php if(is_array($sonclass)) { foreach($sonclass as $item) { ?>
<a href="<?php echo url('news','index',array('pid'=>$item['id']));?>"><span <?php if($_GET['pid']==$item['id']) { ?>class="dtbh1"<?php } ?>
