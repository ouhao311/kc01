...
colModel : [
{display: '编号', name : 'number', width : 140, sortable : false, align: 'center'}, 
{display: '姓名', name : 'truename', width : 100, sortable : false, align: 'center'},      
{display: '性别', name : 'sex', width: 80, sortable : true, align : 'center'}, 
{display: '年龄', name : 'age', width: 120, sortable : true, align : 'center'}, 
{display: '职位', name : 'position', width: 80, sortable : true, align : 'center'},   
{display: '部门', name : 'depart', width: 80, sortable : true, align : 'center'}, 
{display: '学历', name : 'education', width : 120, sortable : false, align: 'center', className: 'handle'},
{display: '手机号', name : 'tel', width: 80, sortable : true, align : 'center'}, 
{display: '操作', name : 'opertation', width: 180, sortable : true, align : 'center'}, 
],  
sortname: "id",
sortorder: "desc"
}); 
