...
colModel : [
{display: '问题', name : 'title', width : 140, sortable : false, align: 'left'}, 
{display: '发布者', name : 'releaseid', width : 100, sortable : false, align: 'left'},      
{display: '描述', name : 'content', width: 220, sortable : true, align : 'left'}, 
{display: '回复', name : 'replyintro', width: 220, sortable : true, align : 'left'},   
