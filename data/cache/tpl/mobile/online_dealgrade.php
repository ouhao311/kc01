...
<!--</div>-->
    ...
    <div class="layui-row mb15 ">
<div class=" layui-col-xs2  layui-col-sm2  layui-col-md2">
<label class="layui-form-title"> 回复评价</label>
</div>
<div class=" layui-col-xs10 layui-col-sm10 layui-col-md10 ">
<div class="layui-input-block">
<textarea name="gradecontent" id="gradecontent" placeholder="请输入问题描述" class="layui-textarea"><?php echo $onlinedata['gradecontent'];?></textarea>
</div>
</div>
</div> 
</div>    
