...
<div class="grace-button grace-border-radius"   onclick="login()">
登录
</div>
<div class="am-sans-serif">
<a href="<?php echo url('register','index');?>" style="margin-top: 10px; float: left; font-size: 14px;">我要注册</a>
<a href="<?php echo url('forget','index');?>" style="margin-top: 10px; float: right; font-size: 14px;">忘记密码？</a>
</div>
</form>
<div class="dwdbXm"> 
<div class="txt">
...
var onlineurl="<?php echo url('online');?>";
<?php if($_GET['gotourl']) { ?>
