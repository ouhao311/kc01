...
<div class=" layui-col-xs9 layui-col-sm9 layui-col-md9">
<div class="layui-input-block">
<?php echo $this->puttree(0,$info['pid']);?>
</div>
</div>
</div>
<div class="layui-row mb15 ">
...
<!--<div class="layui-row mb15 ">-->
<!--<div class=" layui-col-xs2  layui-col-sm2  layui-col-md2">-->
<!--<label class="layui-form-title"><em>*</em> 成功打卡奖励积分</label>-->
<!--</div>-->
<!--<div class=" layui-col-xs9 layui-col-sm9 layui-col-md9">-->
<!--<div class="layui-input-block">-->
<!--<input type="text" name="enccredit" id="enccredit" lay-verify="required|title" placeholder="请输入奖励积分" autocomplete="off" class="layui-input" value="<?php echo $info['enccredit'];?>"> -->
<!--</div>-->
<!--</div>-->
<!--</div>-->
<!--<div class="layui-row mb15 ">-->
<!--<div class=" layui-col-xs2  layui-col-sm2  layui-col-md2">-->
<!--<label class="layui-form-title"><em>*</em> 迟到减扣积分</label>-->
<!--</div>-->
<!--<div class=" layui-col-xs9 layui-col-sm9 layui-col-md9">-->
<!--<div class="layui-input-block">-->
<!--<input type="text" name="deccredit" id="deccredit" lay-verify="required|title" placeholder="请输入减扣积分" autocomplete="off" class="layui-input" value="<?php echo $info['deccredit'];?>"> -->
<!--</div>-->
<!--</div>-->
<!--</div>-->
