    ...
    <table class="flex-table">
      ...
      <tbody>
        ...
        <tr class="hover">
          ...
          <td class="handle">
          <a class="btn red" href="index.php?url=admin&do=gadmin_del&gid=<?php echo $v['gid'];?>" onclick="if(confirm('删除后将不能恢复，确认删除这  1 项吗？')){return true;} else {return false;}"><i class="fa fa-trash-o"></i>删除</a>
          <a class="btn blue" href="index.php?url=admin&do=gadmin_edit&gid=<?php echo $v['gid'];?>"><i class="fa fa-pencil-square-o"></i><?php echo $lang['hx_edit'];?></a>
          </td>
...
function fg_operation(name, grid) {
    if (name == 'add') {
        window.location.href = 'index.php?url=admin&do=gadmin_add';
    }
}
</script>
