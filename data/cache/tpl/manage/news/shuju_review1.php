...
<div class="layui-input-block">
<?php echo getMemberSelects('member',$info['managid']);?> 
</div>
</div>
</div>  
...
<!--<div class="layui-col-xs9 layui-col-sm11 layui-col-md11">-->
<!--<div class="layui-input-block"> -->
<!--<textarea name="reviewinfo" id="reviewinfo" placeholder="请输入回复内容" class="layui-textarea"><?php echo $info['reviewinfo'];?></textarea>-->
<!--</div>-->
<!--</div>-->
<!--</div> -->
