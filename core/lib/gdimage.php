...
class GdImage{
	...
	public function setWatermark($watermark){
		...
		if($watermark['wm_image_name'] != ''){
			$this->set('wm_image_name',HX_UPLOAD.DS.ATTACH_WATERMARK.DS.$watermark['wm_image_name']);
		}
		...
		$this->set('wm_text_font',HX_DATA.DS.'ext'.DS.'font'.DS.$watermark['wm_text_font'].'.ttf');
		$this->set('jpeg_quality',$watermark['jpeg_quality']);
