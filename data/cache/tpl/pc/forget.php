...
<input type="password" required name="regPassword" id="LAY-user-login-password" placeholder="输入新密码" class="layui-input">
</div>
<div class="layui-form-item">
<label class="layadmin-user-login-icon layui-icon layui-icon-password" for="LAY-user-login-password"></label>
<input type="password" required name="qpassword" id="LAY-user-login-password" placeholder="确认新密码" class="layui-input">
</div>
<div class="layui-form-item">
<button class="layui-btn layui-btn-fluid layui-btn-danger js-ajax-submit" type="button"  onclick="forget()">确 定</button>
</div>
...
function forget(){
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo url('forget','preSave');?>",
        data: data,
        dataType: 'json',
