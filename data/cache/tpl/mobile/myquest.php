...
<a href="<?php echo url('task','myquest',array('dodeal'=>0));?>"><span class="banjian_tit"><em style="float:left;width:50%;background-color:#FF4D4F;text-align:center;">未审核</em></span></a>
<a href="<?php echo url('task','myquest',array('dodeal'=>1));?>"><span class="banjian_tit"><em style="float:left;width:49%;background-color:#FF4D4F;text-align:center;border-right:1px solid white;">已审核</em></span></a>
<div item="zixun">
...
<td align="left" valign="middle">
    ...
    <?php if($vl['isreview']=="0") { ?>未审核<?php } ?>
    <?php if($vl['isreview']=="1") { ?>已审核<?php } ?>
    <?php } ?>
    
    
    <?php if($member['identity']=="3") { ?>
    <?php if($vl['istopreview']=="0") { ?>未审核<?php } ?>
    <?php if($vl['istopreview']=="1") { ?>已审核<?php } ?>
    <?php } ?>
    
    
     <?php if($member['identity']=="1"||$member['identity']=="0") { ?>
    <?php if($vl['istopreview']=="0"||$vl['isreview']=="0") { ?>未审核<?php } ?>
    <?php if($vl['istopreview']=="1"&&$vl['isreview']=="1") { ?>已审核<?php } ?>
    <?php } ?>
</td>
...
<td align="left" valign="middle">
<span class="icon_sq"> <a  href="<?php echo url('onlines','add',array('id'=>$vl['id']));?>"title="查看详情">查看详情 </a> </span>
</td>
<td align="left" valign="middle">
<span class="icon_sq"> <a  href="<?php echo url('onlines','dealquest',array('id'=>$vl['id']));?>"title="回复疑问">回复疑问 </a> </span>
</td>
<td align="left" valign="middle">
<span class="icon_sq"> <a  href="<?php echo url('onlines','useranswer',array('id'=>$vl['id']));?>"title="查看用户回复详情">查看用户回复详情 </a> </span>
</td>
<td align="left" valign="middle">
    <?php if($vl['grade']=="1") { ?>满意<?php } ?>
     <?php if($vl['grade']=="2") { ?>一般满意<?php } ?>
      <?php if($vl['grade']=="3") { ?>不满意<?php } ?>
       <?php if(empty($vl['grade'])) { ?>暂无评价<?php } ?>
    </td>
</tr>
<?php } } ?>
</tbody>
