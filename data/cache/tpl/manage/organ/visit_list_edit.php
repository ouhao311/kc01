...
<input type="text" name="name" id="name" lay-verify="required" placeholder="请输入任务名称" autocomplete="off" class="layui-input" value="<?php echo $info['name'];?>"  lay-verify="required"> 
</div>
</div>
</div> 
<div class="layui-row mb15 ">
...
<div class=" layui-col-xs9 layui-col-sm9 layui-col-md9">
<div class="layui-input-block">
<input type="text" name="address" id="address"  placeholder="请输入任务地址" autocomplete="off" class="layui-input" value="<?php echo $info['address'];?>" > 
</div>
</div>
</div> 
