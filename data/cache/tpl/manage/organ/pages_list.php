...
<input class="layui-input"  value="<?php echo date('Y-m-d', strtotime('-7 days'));?>" name="kaishi" placeholder="开始时间" id="LAY_demorange_s" readonly>
</div>
<div class="layui-input-inline">
<input class="layui-input"  value="<?php echo date('Y-m-d',time());?>" name="jieshu" placeholder="截止时间" id="LAY_demorange_e" readonly>
</div>
<div class="layui-input-inline"> 
...
//{display: '英文标题', name : 'entitle', width : 160, sortable : false, align: 'left'},  
