...
class articleModel extends Model {
    ...
    private function _condition($condition){
        ...
        if ($condition['isreview'] != ''){
            $condition_str .= " and article_list.isreview = '". $condition['isreview'] ."'";
        }
        if ($condition['ishot'] != ''){
            $condition_str .= " and article_list.ishot = '". $condition['ishot'] ."'";
        }
        if ($condition['releaseid'] != ''){
            $condition_str .= " and article_list.releaseid = '". $condition['releaseid'] ."'";
        }
        if ($condition['pid'] != ''){
             $condition_str .= " and article_list.pid in (". $condition['pid'] .")";
        }
