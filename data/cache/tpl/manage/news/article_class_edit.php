...
<div class=" layui-col-xs2  layui-col-sm2  layui-col-md2">
<label class="layui-form-title"><em>*</em> 分类名称</label>
</div>
<div class=" layui-col-xs9 layui-col-sm9 layui-col-md9">
<div class="layui-input-block">
<input type="text" name="title" id="title" lay-verify="title" placeholder="请输入分类名称" autocomplete="off" class="layui-input" value="<?php echo $info['title'];?>"> 
</div>
</div>
</div>
<?php if($pid>0&&$_REQUEST['do']=='edit') { ?>
<div class="layui-row mb15 ">
<div class=" layui-col-xs2  layui-col-sm2  layui-col-md2">
...
<div class=" layui-col-xs9 layui-col-sm9 layui-col-md9">
<div class="layui-input-block">
<select name="pid" id="pid" lay-verify="required|pid" lay-filter="pid" lay-search>
<option value="">请选择分类</option>
<?php if(is_array($article_class)) { foreach($article_class as $item) { ?>
<option value="<?php echo $item['id'];?>" <?php if($item['id']==$info['pid']) { ?>selected<?php } ?>
...
<div class=" layui-col-xs9 layui-col-sm9 layui-col-md9">
<div class="layui-input-block">
<select name="cate" id="cate" lay-verify="cate" lay-filter="cate" lay-search>
     <option value="">请选择分类</option>
            <option value="1" <?php if($info['cate']=="1") { ?> selected="selected"<?php } ?>
>动态</option>
             <option value="2" <?php if($info['cate']=="2") { ?> selected="selected"<?php } ?>
>学习</option>
</select>
</div>
</div>
...
<div class="layui-row mb15 ">
<div class=" layui-col-xs2  layui-col-sm2  layui-col-md2">
<label class="layui-form-title"> 分类图标</label>
</div>
<div class=" layui-col-xs9 layui-col-sm9 layui-col-md9">
<div class="layui-input-block">
...
<div class="layui-row mb15 ">
<div class=" layui-col-xs2  layui-col-sm2  layui-col-md2">
<label class="layui-form-title"><em>*</em> 列表模板</label>
</div>
<div class=" layui-col-xs9 layui-col-sm9 layui-col-md9">
<div class="layui-input-block">
<?php echo getNotSelect('templist',$info['templist']);?> 
</div>
</div>
</div>
</div>  
...
<div class="layui-row mb15 pt20">
<div class=" layui-col-xs2  layui-col-sm2  layui-col-md2">
<label class="layui-form-title"> 英文别名</label>
</div>
<div class=" layui-col-xs9 layui-col-sm9 layui-col-md9">
<div class="layui-input-block">
<input type="text" name="en_title" id="en_title" lay-verify="en_title" placeholder="请输入英文别名" autocomplete="off" class="layui-input" value="<?php echo $info['en_title'];?>"> 
</div>
</div>
</div>  
<div class="layui-row mb15 "> 
